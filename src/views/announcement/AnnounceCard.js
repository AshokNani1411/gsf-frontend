                 ...
                 <MDBCol md="12" lg="3" className="mb-4">
                   ...
                   <MDBCard className='cardmain h-100'>
                       ...
                       <a href={`/customer/order/product-detail/${prd.O_XITM}`} className="text-reset mt-2">
                              <h1 className="card-title " style={{fontSize : "20px"}}> {prd.X10CSUBJECT_0}</h1>
                       </a>
                       ...
                       <div className="d-flex justify-content-around h-100">
                                                      ...
                                                      <EllipsisText text={prd.X10CSUBDES_0 }
                                                      length={"5"}
                                                      />
                           ...
                           <MDBCard className='cardmain h-100'>
                               <MDBCardTitle>
                                 ...
                                 <h1 className="card-title " style={{fontSize : "18px", paddingTop : "20px"}}>No Annocements  to display</h1>
