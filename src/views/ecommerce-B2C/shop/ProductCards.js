       ...
       if (mflag) {
          ...
          return (
             <Button
                              ...
                              /*eslint-disable */
                              to = '/customer/ecommerceB2C/checkout'
        ...
        return (
          <Card className='ecommerce-card' key={item.O_XITM}>
            <div className='item-img text-center mx-auto'>
              <Link to={`/customer/ecommerceB2C/product-detail/${item.O_XITM}`}>
            ...
            <CardBody>
              ...
              <h4 className='item-name'>
                <Link className='text-body' to={`/customer/ecommerceB2C/product-detail/${item.O_XITM}`}>
                  {item.O_XITMREF}
                </Link>
