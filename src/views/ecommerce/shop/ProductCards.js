        ...
        return (
          <Card className='ecommerce-card' key={item.name}>
            <div className='item-img text-center mx-auto'>
              <Link to={`/customer/ecommerce/product-detail/${item.slug}`}>
            ...
            <CardBody>
              ...
              <h6 className='item-name'>
                <Link className='text-body' to={`/customer/ecommerce/product-detail/${item.slug}`}>
                  {item.name}
                </Link>
            ...
            <div className='item-options text-center'>
              ...
              <Button
                ...
                {...(item.isInCart
                  ? {
                      to: '/customer/ecommerce/checkout'
                    }
                  : {})}
                /*eslint-enable */
              >
