                 ...
                 <Row>
                   <Col sm='12'>
                             <Card>
                               ...
                               <Button.Ripple color='primary' onClick={() => props.returnInvoice()}>
                                                               Back
                                                 </Button.Ripple>
                                                                                   </CardHeader>
                                           <Row className="terms">
                                           ...
                                           <div className='alert-body'>
                                               ...
                                               <li>For an amount of: <b> {Number(props.totalPayAmount).toFixed(2)} {props.currency} </b></li>
                                          ...
                                          <div>
                                           ...
                                           <div className="radio">
                                            <label style={{fontSize:"18px", fontWeight : "600"}}>
                                              ...
                                              {  selectedCheckBox === "ccard"  ?  <div className="ccard-app"> <CreditCard /> </div> : ''}
                                               </div>
